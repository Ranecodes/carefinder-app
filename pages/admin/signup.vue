    ...
    <div>
      ...
      <form class="signup-content" @submit.prevent="signUp">
        ...
        <div class="form-text text-center">
          <h1 class="text-[32px] font-bold">Create an account</h1>
          <p class="text-[18px] text-[#A5A5A5] pt-[10px]">Lets get started!</p>
        </div>
        ...
        <div class="text-center">
          <p>
            ...
            <a class="text-[#001FC0] font-bold" href="/admin/login">Log in</a>
          </p>
        </div>
      </form>
      <h2
        class="pt-[96px] pb-[76px] text-[13px] text-[#666666] font-bold text-center"
      >
        By creating account you agree to our
        <span class="text-[#001FC0]">Terms of Service</span> and
        <span class="text-[#001FC0]">Privacy Policy</span>
      </h2>
    </div>
