        ...
        <form action="">
          <div class="form-body">
            ...
            <div class="form-right">
              ...
              <textarea name="address" id="address" v-model="address" cols="30" rows="10"></textarea>
...
<path d="M44.3334 30.3288H30.3334V44.3288H25.6667V30.3288H11.6667V25.6621H25.6667V11.6621H30.3334V25.6621H44.3334V30.3288Z" fill="#B0B0B0"/>
              ...
              <input type="file" name="images" id="images" ref="imageInput" v-on:change="handleImageUpload" class="image-upload-input" multiple/>
            </div>
          </div>
...
const supabaseUrl = 'https://mwonivvdfvadcreczajv.supabase.co';
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im13b25pdnZkZnZhZGNyZWN6YWp2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTA4MjI2NjAsImV4cCI6MjAwNjM5ODY2MH0.YoDdWVZEU10Ggtto23FUf7LI1u84bUh_27_Tb36VANE";
let supabase = null;
